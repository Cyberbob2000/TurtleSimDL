...
class TurtleBot3Env(robot_gazebo_env.RobotGazeboEnv):
    ...
    def _check_publishers_connection(self):
        ...
        :return:
        """
        rate = rospy.Rate(self.update_rate_real) #Hz
    ...
    def wait_until_twist_achieved(self, cmd_vel_value, epsilon, update_rate):
        ...
        angular_speed = cmd_vel_value.angular.x
        ...
        while not rospy.is_shutdown():
            ...
            if (current_odometry is not None):
                ...
                odom_angular_vel = -1*current_odometry.twist.twist.angular.x
                ...
                if linear_vel_are_close and angular_vel_are_close:
                    ...
                    break
                rospy.logdebug("update rate: " + str(update_rate))
                if (rospy.get_time() - initialTime > 20 / update_rate):
                    rospy.logdebug("breaking using timeout")
                    break
